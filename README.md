This repo contains my university coursework. It is a convolutional neural network (NOT PRETRAINED) built to be able to identify specific pet breeds from the Oxford Pet dataset. 
